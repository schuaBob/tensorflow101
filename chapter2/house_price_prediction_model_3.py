...
# build model
model = keras.Sequential(name=f'model-{model_version}')
model.add(layers.Dense(64, activation='relu', input_shape=(21,), kernel_regularizer=keras.regularizers.l2(0.001)))
...
model_name = f'Best_model_{model_version}'
